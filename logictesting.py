...
# United Kingdom
    ...
    ('jobs[]', ['13', '208', '292', '323', '335', '761', '1031', '1087', '1094', '1112', '1665', '1679', '1876', '99', '500', '704', '759', '1314']),
    ...
    ('reverse_sort', 'true'),
    ('sort_field', 'bid_count'),#submitdate , highestPrice , for fewest bid_count u need to use ('reverse_sort', 'true') parameter as well :)
...
webtemp1 = ["web development", "website development", "web", "web developer", "web design", "full stack developer" ,"web app", "desktop app", "desktop application", ".Net Core",  "MEAN Stack developer", "MERN Stack developer", "Angular developer", "React", "HTML", "CSS", "JS", "Bootstrap", "NodeJS", "PHP", "WordPress" , "Shopify" ,"Website developer"  ]
